describe("course stats pages", () => {
  ...
  it("shows the per-course stats page for admins", () => {
    ...
    cy.get('[data-cy="course-detail-stats-progress"]').should("contain.text", "38.1%") // (14.3 + 100.0 + 0.0) / 3 = 38.1
    ...
    cy.get('[data-cy="course-learner-stats-table"]').should("contain.text", "100.0%") // completed course status is treated as fully complete
